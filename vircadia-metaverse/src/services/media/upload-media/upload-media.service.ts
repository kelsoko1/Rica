...
const multipartFields: RequestHandler = multipartMiddleware.fields([{ name: 'media' }, { name: 'thumbnail' }]) as unknown as RequestHandler;
...
export default (app: Application): void => {
     ...
     *
     */
    const populateFeathersRequest: RequestHandler = ((
        req: any,
        res: any,
        next: any
    ) => {
